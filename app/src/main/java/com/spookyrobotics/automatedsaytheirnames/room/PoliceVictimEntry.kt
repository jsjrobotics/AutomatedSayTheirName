...
import com.spookyrobotics.automatedsaytheirnames.room.OfflineDatabaseConstants.ManifestTableConstants.COLUMN_UTTERANCE_ID
...
data class PoliceVictimEntry(
        ...
        @ColumnInfo(name = COLUMN_UTTERANCE_ID) val utteranceId: String,
